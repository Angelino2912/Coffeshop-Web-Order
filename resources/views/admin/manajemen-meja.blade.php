...
<div class="stat-row">
    ...
    <div class="stat-card">
        <div class="stat-label">Meja dengan QR</div>
        <div class="stat-value">{{ $mejas->whereNotNull('qr_uuid')->count() }}</div>
    </div>
    <div class="stat-card">
        <div class="stat-label">Belum ada QR</div>
        <div class="stat-value">{{ $mejas->whereNull('qr_uuid')->count() }}</div>
    </div>
</div>
...
<div class="meja-status-section">
    <div style="display:flex; justify-content:space-between; align-items:center; gap:12px; margin-bottom:16px;">
        ...
        <button data-bs-toggle="modal" data-bs-target="#modalTambahMeja"
            ...
            <i class="bi bi-plus-circle"></i> Tambah Banyak Meja
        </button>
    </div>
    ...
    <div class="meja-status-grid">
        @forelse($mejas as $meja)
            ...
            <div class="meja-status-box meja-box-{{ $mejaStatus }}" data-meja="{{ $meja->no_meja }}">
                ...
                <div style="font-size:12px; color:#8a6a54; margin-top:8px;">
                    QR: {{ $meja->qr_uuid ? 'Sudah digenerate' : 'Belum digenerate' }}
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius:16px; padding:8px;">
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title fw-bold">Tambah Banyak Meja</h5>
